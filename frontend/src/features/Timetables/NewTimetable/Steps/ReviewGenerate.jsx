  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6">
      <div className="space-y-6">
          ...
          <div className="pb-4 sm:pb-6">
            <div className="flex items-center mb-4">
              <svg
                ...
                aria-hidden="true"
                data-slot="icon"
                class="h-5 w-5 sm:h-6 sm:w-6 text-indigo-600 mr-2 sm:mr-3"
              >
                <path
        ...
        {/* Generate CTA and Navigation unchanged */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-600 mt-1 text-sm sm:text-base">
                All your data is ready. Click the button to create your
                timetable.
              </p>
            </div>
            <button
              onClick={() => alert("TODO: Connect Django Solver API")}
              className="flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 text-white font-medium rounded-lg shadow-lg transition-all duration-300 w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
